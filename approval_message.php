...
<body>
    ...
    <div class="container">
        <a class="btn" href="admin_denied_users.php">Denied Users</a>
        <h1 class="approval">Teacher Approval</h1>
        <?php

        $teacher_sql = "SELECT * FROM `teacher_details` WHERE `approval` = 'review'";
        ...
        while ($row = mysqli_fetch_assoc($teacher_result)) {
            ...
            echo '<div class="message">
                        ...
                        <div class="buttons">
                            ...
                            <a id="deny" href="approval.php?username=' . $username . '&usertype=teacher&approval=deny" >Deny</a>
                        </div>
                    </div>';
        }
        ?>
        ...
        $student_sql = "SELECT * FROM `student_details` WHERE `approval` = 'review'";
        ...
        while ($row = mysqli_fetch_assoc($student_result)) {
            ...
            echo '<div class="message">
                        ...
                        <div class="buttons">
                            ...
                            <a id="deny" href="approval.php?username=' . $username . '&usertype=student&approval=deny" >Deny</a>
                        </div>
                    </div>';
        }
        ?>

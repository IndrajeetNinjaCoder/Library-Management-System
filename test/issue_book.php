    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($user_type == "") {
            ...
            if ($id_validate and $username_validate and $book_status_validate) {
                ...
                $st_data_sql = "INSERT INTO `st_data` VALUES ('$username', '$user_phone', '$user_branch', '$user_semester', '$book_id', '$book_name', '$book_publisher', current_timestamp(), 0, 'Issued', '$user_type');";

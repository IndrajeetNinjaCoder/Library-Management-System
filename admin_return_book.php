...
$st_data_sql = "UPDATE `st_data` SET `receive_date` = current_timestamp(), `status` = 'Returned' WHERE `st_name` = '$st_username' and `book_id` = '$book_id' and `user_type` = '$usertype'";

$st_data_result = mysqli_query($conn, $st_data_sql);
if ($st_data_result) {
...
<body>
    ...
    <form action="" method="post">
        ...
        <input type="text" name="username" value="<?php echo $st_username; ?>" readonly>
